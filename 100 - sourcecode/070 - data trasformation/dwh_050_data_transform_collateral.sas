/*{
	...
	"Return": ["Table in staging area [DATISTG.DWH_COLLATERAL]",
	           "Process trace"
			   ]
	"Autore": "Hexe S.p.A.",
...
%hx_get_lookup_group(dsMtd=&meta_dslkp_name.,idLookupGroup=GC.1);
%Let msgFunction  = ;
%*-- Retrieve table created by lookup rules;
%Let tableOutName = %sysfunc(fx_get_dsname_outjoin(&meta_dslkp_name.,GC.1,msgFunction));
%Put &=tableOutName;
